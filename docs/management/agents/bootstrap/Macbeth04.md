> Current phase-one task: [M3-04-PHASE1-PRODUCT](../../phase1/Macbeth04-TASK.md), base `18f5352070910a867b9729b031aa2e3951785e01`. Read before historical instructions below; no new ACK is implied.
