# Macbeth02 — M3-02-PHASE1-CONTRACTS

BASE_SHA: `18f5352070910a867b9729b031aa2e3951785e01`
Branch: `macbeth02/m3-phase1-contracts`
Goal: 合约缺口、可重建 ABI/字节码清单、隔离本地部署演练与真实测试网方案
Scope: contracts/**; docs/protocol/PHASE1-*; docs/management/phase1/Macbeth02-*
Dependencies: 以 base 已发布 ABI 开始；接口变化先通知 03/04；不依赖未知销售机制
