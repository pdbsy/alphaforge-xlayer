# Macbeth04 — M3-04-PHASE1-PRODUCT

BASE_SHA: `18f5352070910a867b9729b031aa2e3951785e01`
Branch: `macbeth04/m3-phase1-product`
Goal: 真实入口操作闭环、Pass 转账/获取和 Vault 选择、post-close rescue、浏览器验收
Scope: apps/web/**; test/ui-*.test.ts; test/m3-*-runtime.test.ts; test/m3-product*.test.ts; test/m3-chain-action-flow.test.ts; test/hackathon-ui-build.test.mjs; docs/product/PHASE1-*; docs/management/phase1/Macbeth04-*
Dependencies: 先消费 base ABI/adapter；等待 02/03 新接口精确 SHA；首发分配与转账纳入；付费销售/真实 Buy/Sell 已由用户移出本阶段
