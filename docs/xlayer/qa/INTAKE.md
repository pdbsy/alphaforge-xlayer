...
Expected files: this intake, `PLAN.md`, `ACCEPTANCE-MATRIX.md`, `RESULTS.md`, and `test/xlayer-qa-integration.test.mjs`. Shared npm/CI registration is proposed to the manager, not edited by QA.
